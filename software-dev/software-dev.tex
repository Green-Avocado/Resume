...
\begin{document}
    ...
    \section*{Awards}
        ...
        \begin{tabular}{p{0.2\textwidth} p{0.7\textwidth}} 
            \textbf{2022/01} & \textbf{CyberSci Vancouver Regionals - First Place} \\
            \\
            \textbf{2020/03} & \textbf{Vex Alberta Provincial Tournament - Think Award} \\
            \\
            \textbf{2019/04} & \textbf{U of Calgary Science Engineering and Technology Challenge - First Place} \\
            \\
        \end{tabular}
