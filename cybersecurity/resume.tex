...
\begin{document}
    ...
    \sect{Work Experience}
        ...
        \begin{tabular}{p{0.18\textwidth} p{0.78\textwidth}}
            \textbf{2022/09 - Present} & \textbf{Vulnerability Researcher and Software Developer} \\
            & \emph{Government of Canada} \\
            & \begin{itemize}
                \item Conducted vulnerability research on networking devices using Ghidra and GDB.
                \item Developed software in Rust to parse binary data into a human-readable format.
                \item Reverse engineered and created a Python script for interacting with an unknown
                    binary protocol.
            \end{itemize}
        \end{tabular}

        \begin{tabular}{p{0.18\textwidth} p{0.78\textwidth}}
            \textbf{2022/05 - Present} & \textbf{Undergraduate Academic Assistant} \\
            ...
            & \begin{itemize}
                ...
                \item Used Python to automate student evaluation in computer science and cybersecurity.
            \end{itemize}
        \end{tabular}
    ...
    \sect{Education}
        ...
        \begin{tabular}{p{0.18\textwidth} p{0.78\textwidth}}
            \textbf{2020/09 - 2025/04} & \large\textbf{Bachelor of Science, Major in Computer Science} \\
            & \emph{University of British Columbia} \\
            \\\\\\\\
