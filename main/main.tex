    ...
    \sect{Hackathon Projects}
        ...
        \begin{tabular}{p{0.2\textwidth} p{0.75\textwidth}}
            ...
            & \begin{itemize}
                ...
                \item Implemented a RESTful API to interact with the webpage, allowing users to submit new
                    topics, vote for existing topics, and view the number of votes for each topic.
            \end{itemize}
            \\
        \end{tabular}
