...
\begin{document}
    ...
    \sect{Hackathon Projects}
        ...
        \begin{tabular}{p{0.2\textwidth} p{0.75\textwidth}}
            ...
            & \begin{itemize}
                \item Developed a service to help users find alternative locations that would permit
    ...
    \sect{Personal Projects}
        ...
        \begin{tabular}{p{0.2\textwidth} p{0.75\textwidth}}
            ...
            & \begin{itemize}
                ...
                \item Test website and scan for vulnerabilities using continuous integration.
            \end{itemize}
            \\
        \end{tabular}
